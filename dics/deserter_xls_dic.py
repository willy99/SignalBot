...
PATTERN_PHONE = r'(?i)(?:номер|моб\.?|(?:ефон(у)?)|тел\.?)[\s\w.:+]*?([+\-]?\s?3?8?[\s(-]*0[\d\s-]{2}[\s)-]*[\d\s-]{7,10})\b'
...
PATTERN_ERDR_CONDITIONS_START:Final[str] = r'Короткий вик[л|г|п]ад обставин|Терміново|ВИМОГА|Командиру військової частини А0224|Фабула'
