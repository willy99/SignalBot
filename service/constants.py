...
DB_ALLOWED_TABLES:Final[list[str]] = [DB_TABLE_SUPPORT_DOC, DB_TABLE_DBR_DOC, DB_TABLE_NOTIF_DOC, DB_TABLE_TASK, DB_TABLE_SUBTASK, DB_TABLE_USER, DB_TABLE_ROLE_PERMISSIONS, DB_TABLE_SYS_CONFIG]
